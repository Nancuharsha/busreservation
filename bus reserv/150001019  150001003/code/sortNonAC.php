...
echo "<span class='simple'>SORT BY</span>";
 ...
 via WHERE via.O_id=via_days.O_id &&  via.R_id=via_days.R_id &&  via.B_id=via_days.B_id && Routes.Dept_city='$from' && Arr_city='$to' && via_days.Days= '$res' && Buses.Bus_type='NonA/C' "; 
